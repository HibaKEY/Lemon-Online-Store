...
const products = [
  {
    title: "Citron Lisbonne",
    img: "/citron/Lisbon.png",
    price: 4.40,
    oldPrice: 5,
    rating: 4.8,
    sku: "CL-CLASS-2025",
    tags: ["Clémentine", "Agrume"],
    description: "La variété de Lisbonne, membre de la famille du citron, est cultivée au Maroc pour ses fruits juteux et acidulés. Avec sa peau épaisse et rugueuse, elle prospère dans le climat méditerranéen et ensoleillé du pays. Les citrons de Lisbonne sont prisés dans la cuisine marocaine pour leur saveur vibrante et leur rendement élevé en jus, souvent exportés à l'échelle internationale pour leur qualité.",
    characteristics: [
      "Forme : ovale à légèrement oblong.",
      "Taille : Moyenne à grande.",
      "Couleur de la peau : Jaune vif à maturité, avec une texture lisse et brillante.",
      "Texture de chair : Juicy et tender.",
      "Présence de graines : Peu de graines, généralement présentes mais en petites quantités.",
      "Fermeture : Modérée, offrant une légère résistance mais pas trop dure.",
      "Arôme : Équilibré, avec une acidité rafraîchissante et un arôme intense.",
      "Teneur en jus : Typiquement environ 40 à 50 % en poids.",
      "Acidité: Habituellement comprise entre 5 et 8 %.",
      "Rapport sucré/acidité : environ 10 à 15 %.",
    ],
    informations: ["Origine : Maroc", "Saison : Décembre - Février", "Poids : 100-130g"],
    exportations: [
      { country: "Canada", value: 88 },
