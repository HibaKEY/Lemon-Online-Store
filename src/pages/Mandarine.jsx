...
const products = [
  {
    title: "Clémentine Nardocott",
    img: "/mandarine/nadorcott.png",
    price: 10.15,
    oldPrice: 11,
    rating: 4.8,
    sku: "CL-NARD-2025",
    ...
    description:
      "Découvert par les domaines agricoles en collaboration avec l'INRA et commercialisé sous l'étiquette Authentic Afourer Seedless...",
    characteristics: [
      "Forme : Sphérique aplatie.",
      "Taille : Petite à moyenne.",
      "Couleur de la peau : Orange avec des taches jaunâtres...",
    ],
  ...
  {
    title: "Clémentine Nova",
    img: "/mandarine/nova.png",
    price: 11,
    oldPrice: 11.5,
    rating: 4.9,
    sku: "CL-NOVA-2025",
    tags: ["Clémentine", "Agrume"],
    description: "La Nova se distingue par ses fruits de grande taille de couleur orange intense...",
    characteristics: [
      "Forme : Légèrement aplatie.",
      "Taille : grande",
      "Couleur de la peau : orange jaune à orange vif à maturité...",
    ],
    informations: ["Origine : Maroc", "Saison : Décembre - Février", "Poids : 100-130g"],
    exportations: [
      { country: "Canada", value: 87 },
...
const MandarinePage = () => {
  ...
  const handleAddToCart = (p) => {
    ...
    const uniqueId = `${p.sku}-${selectedBrand}`; // Unique ID with brand
    addItem({
      id: uniqueId,
      name: p.title,
      image: p.img,
